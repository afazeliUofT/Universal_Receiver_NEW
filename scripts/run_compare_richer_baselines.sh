...
python tests/regression_baseline_builds.py --config configs/target_cdlc_highmobility_richer_baselines.yaml
python -m upair5g.cli eval \
  --config configs/target_cdlc_highmobility_richer_baselines.yaml \
